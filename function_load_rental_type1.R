...
# specially for time_split_type1
# i.e. dataset in Q3 2015
load_rental_type1 <- function(rental_file){
  # load data
  # rental <- read.csv("HealthyRideRentals 2015 Q3.csv")
  ...
  mean <- aggregate(TripDuration ~ FromStationId + 
                      Start_Month + Start_Day + 
                      Start_Year + Start_Hour, data=rental, mean)
  # Sort by stat,FromStationId, Start_Year, Start_Month, Start_Day, Start_Hour
  ...
  median <- aggregate(TripDuration ~ FromStationId + 
                        Start_Month + Start_Day + 
                        Start_Year + Start_Hour, data=rental, median)
  # Sort by stat,FromStationId, Start_Year, Start_Month, Start_Day, Start_Hour
